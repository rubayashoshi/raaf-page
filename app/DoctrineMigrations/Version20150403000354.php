...
class Version20150403000354 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE properties (id INT AUTO_INCREMENT NOT NULL, property_type_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, description VARCHAR(255) NOT NULL, date_available DATE NOT NULL, rent NUMERIC(2, 0) NOT NULL, available_to_couple TINYINT(1) NOT NULL, is_agent TINYINT(1) NOT NULL, contact_phone TINYINT(1) NOT NULL, contact_email TINYINT(1) NOT NULL, contact_name VARCHAR(255) NOT NULL, rent_period enum('monthly', 'weekly'), INDEX IDX_87C331C79C81C6EB (property_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
